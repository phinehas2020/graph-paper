...
export function PlannerInspector({
  ...
  return (
    <div className="panel-surface panel-glow w-full border border-white/80 bg-white/88 px-4 py-4 shadow-[0_24px_70px_-38px_rgba(15,23,42,0.5)] backdrop-blur-xl">
