...
function getPathDiagnostics(id, sourceNodeId, length, label) {
    if (length > 0)
        return [];
    return [
        {
...
function getWireMaterialCode(wireType) {
    return /14[\/-]3/i.test(wireType) ? 'mep.wire.nm-b.14-3' : 'mep.wire.nm-b.12-2';
}
export function compileMepSystems(topology, rulePack) {
    const results = [];
